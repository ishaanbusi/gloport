import { ArrowRight, Zap, Target, Globe2, Heart, MapPin, Phone, Mail, Stethoscope, Globe, ArrowLeft, ArrowUp } from 'lucide-react';
...
export default function Home() {
    ...
    return (
        <>
            ...
            <Fade top duration={2000}>
              <section id="home" className="relative bg-[#3bd6c6] transition-transform duration-500 transform hover:scale-105">
                ...
                <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="m-4 text-lg font-normal tracking-tight text-white text-center">
                        At Gloport Photon<span className="text-red-500">i</span>x, we are committed to creating cutting-edge solutions that empower early disease detection, drive innovation in medical diagnostics, and enhance healthcare outcomes.
                    </p>
  ...
  <section
    id="about"
    className="px-10 py-16 bg-white shadow-lg flex flex-col md:flex-row transition-all duration-300 hover:shadow-2xl"
  >
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1 flex flex-col justify-center">
      <div className="text-left">
        <h2 className="text-4xl text-[#3bd6c6] sm:text-4xl">
          About Gloport Photon<span className="text-red-500">i</span>x
        </h2>
        <p className="mt-4 text-lg text-gray-600 text-justify">
          Gloport Photon<span className="text-red-500">i</span>x is a deep-tech company at the forefront of developing advanced healthcare & Life science’s solutions using photonics technology. Our mission is to transform the global healthcare landscape by enabling early-stage disease detection, particularly in cancer diagnostics, and delivering breakthrough innovations that push the boundaries of medical science. Our technologies are designed to be non-invasive, highly accurate, and accessible to healthcare providers worldwide.
        </p>
        <p className="mt-4 text-lg text-gray-600 text-justify">
          We are dedicated to continuous improvement and innovation, ensuring that our solutions meet the evolving needs of healthcare professionals and patients alike. Our team of experts works tirelessly to research and develop new technologies that enhance diagnostic capabilities and improve patient outcomes.
        </p>
      </div>
    </div>
    <div className="flex-1 flex items-center justify-center mt-8 md:mt-0">
      ...
      />
            ...
            <Fade right duration={2000}>
              <section id="services" className="relative py-16 bg-[#3bd6c6] flex flex-col md:flex-row transition-transform duration-300 hover:scale-105">
                <div className="absolute inset-0">
                    <img
                        className="w-full h-full object-cover"
                        src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-1.2.1&auto=format&fit=crop&w=2850&q=80"
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1">
                    <div className="text-left">
                        ...
                        <p className="mt-4 text-lg text-white text-justify">
                            Early diagnosis saves lives, and at Gloport Photonix, we are pioneering
                            new ways to detect diseases before symptoms arise. Our flagship product,
                            the Advanced Breath Analyzer, leverages photoacoustic technology in
                        ...
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md transition duration-300 transform hover:scale-105 hover:shadow-2xl">
                                ...
                                <p className="mt-2 text-gray-600">
                                    Our breath analyzer is designed to provide accurate results without
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md transition duration-300 transform hover:scale-105 hover:shadow-2xl">
                                ...
                                <p className="mt-2 text-gray-600">
                                    By harnessing the power of multi-wavelength lasers and advanced
                                    signal processing, our technology delivers instant, real-time
                                    insights.
                                </p>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md transition duration-300 transform hover:scale-105 hover:shadow-2xl">
                                ...
                                <p className="mt-2 text-gray-600">
                                    Built to serve both large hospitals and remote healthcare facilities,
                                    our products are accessible and adaptable.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <Fade bottom duration={2000}>
              <section id="mission" className="py-16 bg-white transition-transform duration-300 hover:scale-105">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row">
                    <div className="flex-1 text-left">
                        <h2 className="text-2xl font-normal text-[#3bd6c6]">
                            Our Mission
                        </h2>
                        <p className="mt-4 text-lg text-gray-600 text-justify">
                            At Gloport Photon<span className="text-red-500">i</span>x, we believe in the power of innovation to change the world. Our mission is to develop photonics-based technologies that not only improve healthcare outcomes but also make early diagnostics more accessible across diverse populations. Through continuous research, collaboration, and technological advancement, we are committed to building a future where early-stage disease detection is the norm, not the exception.
                        </p>
                        <Wave />
                    </div>
                    <div className="flex-1 flex items-center justify-center mt-8 md:mt-0">
            ...
            {/* Technology Section */}
            <Fade left duration={2000}>
              <section id="innovation" className="relative py-16 bg-[#f0f4f8] transition-transform duration-300 ">
                <div className="absolute inset-0">
                    <img
                        className="w-full h-full object-cover"
                        src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-1.2.1&auto=format&fit=crop&w=2850&q=80"
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-left">
                        ...
                        <p className="mt-4 text-lg text-white text-justify">
                        Our technology solution is set to revolutionize the early detection of cancer and other serious conditions, giving healthcare providers the tools they need to intervene earlier and Utilizing laser-induced acoustic waves to enable precise real-time detection of molecular signatures.
                        </p>
                        ...
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md transition duration-300 transform hover:scale-105 hover:shadow-2xl">
                                ...
                                <p className="mt-2 text-gray-600">
                                    Harnessing sound waves generated by laser-light interactions to
            ...
            <Fade right duration={2000}>
              <section id="why-us" className="py-16 bg-white shadow-lg transition-transform duration-300 hover:scale-105">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-left">
                        <h2 className="text-3xl tracking-tight text-[#3bd6c6] sm:text-3xl">
                            Why Choose Gloport Photon<span className="text-red-500">i</span>x?
                        </h2>
                        <p className="mt-4 text-lg text-gray-600 text-justify">
                            With our unique blend of scientific expertise and innovative product development, Gloport Photon<span className="text-red-500">i</span>x offers revolutionary solutions that can redefine healthcare diagnostics. Our advanced breath analyzers are built with a vision to help doctors detect diseases earlier, improving survival rates and enhancing patient outcomes.
                        </p>
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      {stats.map((stat) => (
        ...
        >
          ...
          <p className="mt-2 text-sm font-medium text-gray-500">{stat.label}</p>
            ...
            <Fade bottom duration={2000}>
              <section id="testimonial" className="py-16 bg-white transition-transform duration-300 hover:scale-105">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-left">
                        <h2 className="text-3xl tracking-tight text-[#3bd6c6] sm:text-3xl">
                        ...
                        <Slider {...{
                            ...
                            slidesToShow: 1,
                            slidesToScroll: 1,
                            prevArrow: <button className="absolute left-0 z-20 p-2 text-black hover:text-gray-600"><ArrowLeft className="h-6 w-6 text-black" /></button>,
                            nextArrow: <button className="absolute right-0 z-20 p-2 text-black hover:text-gray-600"><ArrowRight className="h-6 w-6 text-black" /></button>,
                        }}>
                            ...
                            <blockquote className="mt-4 text-lg text-gray-600 italic">
                                ...
                                <footer className="mt-2 text-gray-500">– Dr. D K Thakur                                </footer>
                            </blockquote>
                            <blockquote className="mt-4 text-lg text-gray-600 italic">
                                “Their commitment to early detection is truly commendable and impactful.”
                                <footer className="mt-2 text-gray-500">– Dr. Pavan Kumar                                </footer>
                            </blockquote>
                        </Slider>
                    </div>
                </div>
            ...
            <Fade duration={2000}>
              <section id='team' className="relative bg-[#3bd6c6] transition-transform duration-300 hover:scale-105">
                <div className="absolute inset-0">
                    <img
                        className="w-full h-full object-cover"
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 p-6 bg-white">
    ...
    <div className="group relative bg-cover bg-center h-[350px] rounded-lg overflow-hidden shadow-lg" style={{ backgroundImage: "url('https://i.postimg.cc/pT1HKRmt/3.jpg')" }}>
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white opacity-0 group-hover:opacity-100 transition duration-500">
        <p className="text-lg text-center">With a career spanning over 28 years, Abhijeet has excelled across diverse sectors, including IT, Banking, Insurance, Electronics, and Electric Vehicle (EV) subsystems.</p>
      </div>
    </div>

    <div className="group relative bg-cover bg-center h-[350px] rounded-lg overflow-hidden shadow-lg" style={{ backgroundImage: "url('https://i.postimg.cc/W1TXPLby/Whats-App-Image-2025-01-01-at-15-02-37.jpg')" }}>
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white opacity-0 group-hover:opacity-100 transition duration-500">
        <p className="text-lg text-center">A visionary entrepreneur with over 30 years of leadership in logistics and infrastructure, is the Founder and Chairman of GloPort PhotoniX Innovations Pvt. Ltd.,</p>
      </div>
    </div>

    <div className="group relative bg-cover bg-center h-[350px] rounded-lg overflow-hidden shadow-lg" style={{ backgroundImage: "url('https://i.postimg.cc/52gp47X2/Whats-App-Image-2025-01-01-at-15-02-37-1.jpg')" }}>
      <div className="absolute inset-0 bg-black bg-opacity-30 group-hover:bg-opacity-80 transition duration-500"></div>
      <div className="absolute inset-0 flex flex-col justify-between p-6 text-white opacity-100 group-hover:opacity-0 transition duration-500">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white opacity-0 group-hover:opacity-100 transition duration-500">
        <p className="text-lg text-center">With over 12 years of distinguished experience in financial management, she has established herself as a powerhouse in financial strategy, investment control, and operational excellence.</p>
      </div>
    </div>
    ...
    <div className="group relative bg-cover bg-center h-[350px] rounded-lg overflow-hidden shadow-lg" style={{ backgroundImage: "url('https://i.postimg.cc/pT1HKRmt/3.jpg')" }}>
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white opacity-0 group-hover:opacity-100 transition duration-500">
        <p className="text-lg text-center">He is a seasoned leader with over 27 years of experience in business development, strategic marketing, and operational growth across India & abroad.</p>
      </div>
    </div>
    ...
    <div className="group relative bg-cover bg-center h-[350px] rounded-lg overflow-hidden shadow-lg" style={{ backgroundImage: "url('https://i.postimg.cc/pT1HKRmt/3.jpg')" }}>
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white opacity-0 group-hover:opacity-100 transition duration-500">
        <p className="text-lg text-center">He is an eminent scientist in photonics technologies with over 35 years of R&D experience. He envisions revolutionizing healthcare diagnostics through breakthrough photonics technologies.</p>
      </div>
    </div>
    ...
    rel="noopener noreferrer"
            ...
            <Fade left cascade duration={2000}>
              <section id='contact-us' className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 transition-transform duration-300 hover:scale-105">
                <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-2xl transition duration-300">
                            ...
                            <p className="text-gray-600">Gloport Photonix
Floor 21, TTC Industrial Area, MIDC Industrial Area, Pawne, Navi Mumbai, Maharashtra 400705
</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-2xl transition duration-300">
